...
teachers :: [Teacher]
teachers = [Teacher 100 (Name "Simon" "De Beauvior"), Teacher 200 (Name "Susan" "Sontag")]
...
finalReslut :: [Name]
finalReslut = _hinq (_select (teacherName . fst)) (_join teachers courses teacherId teacher) (_where ((== "English") .courseTitle . snd))
...
enrollments = [(Enrollment 1 101),(Enrollment 2 101)
              ...
              ,(Enrollment 4 101),(Enrollment 4 101)
...
getEnrollments courseName = runHINQ courseQuery
    where courseQuery = HINQ (_select (fst . fst)) (_join studentEnrollments courses snd courseId) (_where ((== courseName) . courseTitle . snd))
